...
//  getFirstInCol
//  --------------------------------------------------
int	Grid::getFirstInCol(int	sector)	{
...
//  getRow
//  --------------------------------------------------
int	Grid::getRow(int	sector)	{
				return	sector	/	SECTOR_COLUMNS;
}
...
int	Grid::shiftInCol(int	sector,	int	shift)	{
				...
				int	last_sector_in_col	=
				  SECTOR_COLUMNS	*	(SECTOR_ROWS	-	1)	+	getCol(sector);
...
//  randomSector
//  --------------------------------------------------
int	Grid::randomSector()	{
				return	rand()	%	sectors.size();
}
...
int	Grid::mirrorSector(int	sector)	{
				int	ret	=	mirrorUpDown(sector);
				ret	=	mirrorLeftRight(ret);
				return	ret;
}
...
//  getReversed
//  --------------------------------------------------
int	Grid::getReversed(int	sector)	{
				return	sectors_reversed[sector];
}
